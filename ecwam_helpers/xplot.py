...
exps=['etopo1_oper_an_fc_O48_cy50r1']

rundir='/path/to/model/output'     # base directory of the model runs
plotdir='/path/to/plot/output'     # directory where the plots will be saved
